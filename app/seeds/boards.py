...
def seed_boards():
    board1 = Board(title='Capstone Project', user_id=1)
    board2 = Board(title='Work Tasks', user_id=2)
    board3 = Board(title='Project Management', user_id=3)
    board4 = Board(title='Job Search', user_id=1)
    board5 = Board(title='Personal Task', user_id=1)
    board6 = Board(title='Vacation Planning', user_id=2)
    board7 = Board(title='Grocery List', user_id=1)
